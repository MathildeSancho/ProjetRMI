...
public class PlusDeDeuxMois  implements java.io.Serializable {
    private upem.rmi.upesellservice.Produit p;

    public PlusDeDeuxMois() {
    }
    ...
    /**
     * Gets the p value for this PlusDeDeuxMois.
     * 
     * @return p
     */
    ...
    /**
     * Sets the p value for this PlusDeDeuxMois.
     * 
     * @param p
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof PlusDeDeuxMois)) return false;
        PlusDeDeuxMois other = (PlusDeDeuxMois) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(PlusDeDeuxMois.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://upesellservice.rmi.upem", ">plusDeDeuxMois"));
